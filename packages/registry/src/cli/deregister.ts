...
import { deregister } from '../circuits/deregister';
...
function main(): Promise<TxResult> {
    ...
    const [contractAddress, registryKeyFile, recipientAddress] = program.args;
    ...
    return withAppContext(networkId, (ctx) => deregister(ctx, {
        contractAddress,
        privateStateId,
        secretKey,
        recipientAddress,
