      ...
      <div className="relative flex h-screen flex-col overflow-hidden">
        ...
        >
          <div className="relative z-10 flex min-h-0 flex-col">
            <main className="ces-main-stage relative flex min-h-0 flex-1 items-center justify-center overflow-hidden px-4 py-[var(--ces-space-shell-y)] sm:px-6 sm:py-[calc(var(--ces-space-shell-y)+0.25rem)] lg:px-8 lg:py-[var(--ces-space-shell-y-lg)]">
              <UnicornBackdrop />
          ...
          <aside
            className="relative z-10 flex border-t border-ces-border bg-black lg:min-h-0 lg:border-l lg:border-t-0"
            style={{ width: RIGHT_RAIL_WIDTH, flex: `0 0 ${RIGHT_RAIL_WIDTH}` }}
          >
            <div className="flex w-full flex-col lg:min-h-0 lg:flex-1">
              <div className="flex min-h-[46px] items-center justify-end border-b border-ces-border px-2 lg:hidden">
                <button
                  type="button"
                  onClick={onWalletConnect}
                  disabled={walletConnected || walletConnecting}
