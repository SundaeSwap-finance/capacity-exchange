...
export class HealthReadyGet200ResponseAnyOfWallet {
    'status': HealthReadyGet200ResponseAnyOfWalletStatusEnum;
    'error': string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "status",
            "baseName": "status",
            "type": "HealthReadyGet200ResponseAnyOfWalletStatusEnum",
            "format": ""
        },
        {
            "name": "error",
    ...
    static getAttributeTypeMap() {
        return HealthReadyGet200ResponseAnyOfWallet.attributeTypeMap;
    }
...
export enum HealthReadyGet200ResponseAnyOfWalletStatusEnum {
    Ko = 'ko'
}
